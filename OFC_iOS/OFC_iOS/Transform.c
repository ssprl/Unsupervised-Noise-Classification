...
Transforming*
newTransforms(int window, int framesPerSecond)
{
	Transforming* newTransform = (Transforming*)malloc(sizeof(Transforming));
...
void
ForwardFFTransform(Transforming* fft, float* realInput)
{
...
void
InverseFFTransform(Transforming* fft)
{
	int i,j,k,L,m,n,o,p,q;
...
void
destroyTransforms(Transforming** transform)
{
	if(*transform != NULL){
